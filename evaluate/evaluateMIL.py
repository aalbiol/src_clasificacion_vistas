...
if __name__ == "__main__":
    ...
    dataset,tipos_defecto=pl_datamodule.genera_ds_jsons_multilabelMIL(root_folder,  train_dataplaces, maxvalue=maxvalues, defect_types=tipos_defecto, in_memory=True,channel_list=model.channel_list)
    ...
    for caso in tqdm(dataset):
        ...
        nombre_cimg += ".cimg" 
        results=model.predict(nombre_cimg,device,include_images=False)
    ...
    dataset,tipos_defecto=pl_datamodule.genera_ds_jsons_multilabelMIL(root_folder,  val_dataplaces, maxvalue=maxvalues, defect_types=tipos_defecto, in_memory=True,channel_list=model.channel_list)
